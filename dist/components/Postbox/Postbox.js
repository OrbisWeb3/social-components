...
export default function Postbox({
  ...
  if (user) {
    return /*#__PURE__*/React.createElement("div", {
      className: "flex justify-center flex-col items-center rounded-md"
      ...
      className: "overflow-hidden rounded-lg border shadow-sm w-full focus-within:border-[#93bcf7] focus-within:ring-1 focus-within:ring-[#93bcf7]",
      style: {
      ...
      className: "p-2 pt-1 pb-0 flex-row align-center flex",
      style: {
        alignItems: "center"
      }
      ...
      className: "text-sm font-medium rounded-md px-1 py-1",
      style: {
      ...
      type: "submit",
      className: sendStyle + ' bg-blue-200',
      disabled: true
      ...
      className: "inline-flex items-center rounded-full border border-transparent bg-gray-100 text-gray-600 px-5 py-2 text-base font-medium text-white shadow-sm hover:bg-gray-200 focus:outline-none cursor-pointer mr-2",
      onClick: () => setEditPost(false)
    }, "Cancel"), /*#__PURE__*/React.createElement("button", {
      type: "submit",
      className: sendStyle
    }, defaultPost ? /*#__PURE__*/React.createElement(React.Fragment, null, "Edit post") : /*#__PURE__*/React.createElement(React.Fragment, null, "Comment"), /*#__PURE__*/React.createElement("svg", {
      width: "13",
      height: "11",
      viewBox: "0 0 13 11",
      fill: "none",

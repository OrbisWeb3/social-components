...
const Comments = ({
  ...
  return /*#__PURE__*/React.createElement(GlobalContext.Provider, {
    ...
    className: "orbis orbis-comments-container shadow rounded-md w-full",
    style: {
  ...
  }, "There isn't any comment here yet."), /*#__PURE__*/React.createElement(EmptyStateComments, null)) : /*#__PURE__*/React.createElement("div", {
    role: "list"
  }, /*#__PURE__*/React.createElement(LoopComments, {
    comments: comments
  })))), /*#__PURE__*/React.createElement("div", {
    ...
    rel: "noreferrer",
    target: "_blank",
    className: "flex-row flex justify-center items-center hover:underline hover:decoration-gray-300 cursor-pointer underline-offset-4"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ml-2 flex text-base mr-2 font-normal",
    style: {
      color: getThemeValue("color", theme, "secondary")
    }
...
function Comment({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute top-5 left-5 -ml-px rounded-md",
    style: {
      top: 50,
      bottom: 20,
      width: 1,

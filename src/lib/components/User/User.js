...
export const UserPopup = ({details}) => {
  ...
  return(
    <div className="absolute py-4 px-5 z-50 rounded-lg overflow-hidden min-w-[310px] max-w-[390px] drop-shadow-lg border" style={{top: 30, background: theme?.bg?.secondary ? theme.bg.secondary : defaultTheme.bg.secondary, borderColor: theme?.border?.main ? theme.border.main : defaultTheme.border.main }}>
      {/** Top part */}
